...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p class="form-row form-row-wide form-group" id="calc_shipping_state_field">
			<?php
				...
				// Dropdown Input
					...
					?><span>
						<select name="calc_shipping_state" id="calc_shipping_state" class="form-control" placeholder="<?php esc_attr_e( 'State / county', 'woocommerce' ); ?>">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button btn_full"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
