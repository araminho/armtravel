                                ...
                                <div class="row" id="rating_summary">
                                    <div class="col-md-6">
                                        <ul>
                                            ...
                                            <li><?php echo esc_html( $review_fields[$i] ); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="date-pick form-control" placeholder="<?php echo ct_get_date_format('html'); ?>" data-date-format="<?php echo ct_get_date_format('html'); ?>" type="text" name="date_from" value="<?php echo esc_attr( $date_from ); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                             <div class="form-group">
                                                ...
                                                <input class="date-pick form-control" placeholder="<?php echo ct_get_date_format('html'); ?>" data-date-format="<?php echo ct_get_date_format('html'); ?>" type="text" name="date_to" value="<?php echo esc_attr( $date_to ); ?>">
                                            </div>
                                        </div>
                                    </div>
